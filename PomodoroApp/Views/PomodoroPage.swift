...
//    {
//        
//        referenceDate = self.nowDate + 25 * 60
//      
//         
//        
//    }
...
//    {
//        Image("Ellipse").resizable().frame(width: 85, height: 85)
//    }
//    var body: some View {
//        
//        ZStack{
...
//                
//                HStack{
//                    ellipse.overlay(  Text(countDownString(from: referenceDate).0)
//                        
//        //                .onAppear(perform: {
//        //                    _ = self.timer
//        //                }
...
//                    , alignment: .center)
//                  
//                    ellipse.overlay(   Text(countDownString(from: referenceDate).1)
//       
//                    , alignment: .center)
//                    
//      
...
//                    }
//                
////                if referenceDate == Date.now - 25 * 60 {
////                    test()
////
////                }
//              
...
//    }
//
//    func countDownString(from date: Date) -> (String,String) {
